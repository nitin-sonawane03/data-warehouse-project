...
|----------|-------------|
| [`docs/data_catalog.md`](docs/data_catalog.md) | Every column — name, type, description, example |
| [`docs/architecture.png`](docs/architecture.png) | High level architecture diagram |
| [`docs/data_flow.png`](docs/data_flow.png) | Data lineage — source to Gold |
| [`docs/data_integration.png`](docs/data_integration.png) | Table relationships diagram |
| [`docs/data_layers.png`](docs/data_layers.png) | Bronze vs Silver vs Gold comparison |
| [`docs/data_model.png`](docs/data_model.png) | Star schema ERD |
